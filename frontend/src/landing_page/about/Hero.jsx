...
function Hero() {
    return (
        <div className="container  p-5" >
            ...
            <div className="row mt-5 border-top pt-5 text-muted" style={{fontSize:"1.1rem", lineHeight:"1.8rem", color:" color: #424242;", fontWeight: "400",}}>
                <div className="col py-5 ps-lg-5" >
                ...
                <div className="col py-5 pe-lg-5">
